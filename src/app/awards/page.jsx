...
const page = () => {
    const text = [
        ...
        { icon: "./OQBI_Logo_10.png", strong: "Industry Engagement: Comex 2024", rest: "Represented OQ Base Industries at Comex 2024, a premier technology exhibition held in Muscat, Oman. This participation highlights engagement with cutting-edge industry trends and advancements." },
    ]
        ...
        <motion.div className="h-full overflow-auto relative  " initial={{ y: "-200vh" }} animate={{ y: "0%" }} transition={{ duration: 1 }}>
            ...
            <div className='flex flex-col p-4 xm:p-8 sm:p-8 md:p-12 lg:p-20 xl:p-30 gap-10 xs:items-start md:items-start sm:items-start lg:items-center justify-center'>
                ...
                <div className="h-full flex flex-col lg:flex-row lg:gap-10 px-4 py-2 md:gap:50 bg-red-50 rounded">
                    ...
                    >
                        <Image src='https://lh6.googleusercontent.com/ImyvTuyajhTs5NZ_j_bpDcM1tQ7jDr6ZITYbkYp7V8lgnksBld3WzbStMBzMIjj4dx6Lg3OVSze-E4J234GA4kg=w16383'
                            alt=''
                            width={800}
                            height={600}
                            className='rounded'
